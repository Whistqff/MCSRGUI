instanceFormat := "RSG" ; The name format of your instances (i have instance1, instance2 etc so its 'instance')
instanceCount := "0"
multimcDir := "" ; Change this to match your MultiMC.exe location
instanceFolder := ""
seed := "" ; Leave empty if you don't want to use a seed

obsDir := "" ; Replace this with where your OBS directory is located. (Shortcut reccomended)
